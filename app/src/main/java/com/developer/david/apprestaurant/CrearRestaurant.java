...
public class CrearRestaurant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RegistroRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CrearRestaurant.this, ListRestaurant.class);
                senResgistrar();
    ...
    public void senResgistrar(){
        ...
        req.put("Log",crear_restaurant.lat);
        req.put("Lat",crear_restaurant.lng);
    ...
    private void crearGaleria() {
        Intent intent = new Intent(CrearRestaurant.this, subirImg.class);
        startActivity(intent);
    }
}