...
public class ListRestaurant extends AppCompatActivity {
    ...
    FloatingActionButton nuevoRestaurant;
    ...
    private void loadDescripcion() {
        ...
        View nuevoRestaurant = findViewById(R.id.createRetaurant);
        if (UserDataServer.MSN.equals("C")) {

            nuevoRestaurant.setVisibility(View.GONE);
        }
        nuevoRestaurant.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {


                    Intent intent = new Intent(root, crear_restaurant.class);
